...
% inputDir
    ...
    % s0216_contrasts.mat
    % 
    % these contrasts.mat files could be generated by python script
...
startTime = ez.moment();
contrastFiles = ez.ls(inputDir,'s\d\d\d\d_contrasts\.mat$'); % contrastFiles across all subjects
...
for n = 1:ez.len(subjects)
    ...
    % fill out SPM dir
    SPMFolder = ez.joinpath(inputDir, [subject '_SPM']);
    matlabbatch{1}.spm.stats.con.spmmat = {SPMFolder};
