...
% Output:
%       ROI_label_5mmsphere_x_y_z_roi.mat (nii export could be tricky, because of voxel size)
...
sphere_label = ['ROI_' labels{i}, '_', num2str(sphere_radius) 'mmsphere'  '_' num2str(round(xyz(i,1))) '_' num2str(round(xyz(i,2))) '_' num2str(round(xyz(i,3))), '_roi'];
...
ROIs = cellstr(spm_select('List',folder,['^ROI_.*mmsphere_.*_roi.mat']));
