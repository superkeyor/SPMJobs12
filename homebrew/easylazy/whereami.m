...
function main(varargin)
    if nargin==0
        try
            ...
            newheader = {'Lobe','Hemisphere','xjView','SPM','Anatomy_GreyMatter','Number','Anatomy','BA','Hem','x','y','z','Z score','k','url','x_tal','y_tal','z_tal','Anatomy_Matter','Cluster_p_FWE','Cluster_p_FDR','Cluster_p','Peak_p_FWE','Peak_p_FDR','T','Peak_p'};
