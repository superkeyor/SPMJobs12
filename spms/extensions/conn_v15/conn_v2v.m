...
switch(lower(option))
    case {'measures','empty'}
        measures=struct(...
            'names',{{'connectome-MVPA','IntegratedLocalCorrelation','RadialCorrelationContrast','IntrinsicConnectivityContrast','RadalSimilarityContrast'}},... % connectome-level Multivariate Pattern Analysis; Integrated Local Correlation; Radial Correlation Contrast; Intrinsic Connectivity Contrast; Radial Similarity Contrast; 
            'measuretype',{{2,1,1,1,1}},...
            'localsupport',{{0,8,8,0,0}},...
            'global',{{nan,0,0,1,1}},...
            'deriv',{{nan,0,1,0,1}},...
            'norm',{{1,1,1,1,1}},...
            'filename',{{'','','','',''}},...
            'dimensions_out',{{4,1,3,1,3}},...
            'dimensions_in',{{64,64,64,64,64}});
