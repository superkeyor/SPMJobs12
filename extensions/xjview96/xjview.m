...
handles.infoTextBox = uicontrol(handles.figure, 'style','edit',...
        ...
        'String', 'Welcome to xjView','ForeGroundColor','k', 'BackgroundColor', 'w',...
