...
if ~numel(files)
    ...
    handles.cancel=uicontrol(handles.panel,'style','pushbutton','units','norm','position',[.425,.025,.15,.075],'string','Exit','callback','close(gcbf)','tooltipstring','<HTML>Exit this window <br/> - processes will continue running<br/> - visit Tools.GridJobs to see this job progress <br/> - until this job is finished <b>do not modify this project or run other jobs</b><br/> - when finished re-load your project to merge the results and save your project again to keep those changes</HTML>');
